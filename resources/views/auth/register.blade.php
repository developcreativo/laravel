...
@section('content')
    ...
    <div class="block block-themed animated fadeIn">
        ...
        <div class="block-content block-content-full block-content-narrow">
            ...
            <form class="js-validation-register form-horizontal push-10-t push-10" action="/auth/register"
                  method="post">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <div class="form-group">
                    <div class="col-xs-12">
                        <div class="form-material form-material-success">
                            <input class="form-control" type="text" id="register-username" name="name"
...
@stop
@section('scripts')
    {!! HTML::script('assets/js/pages/base_pages_register.js')!!}
@stop
